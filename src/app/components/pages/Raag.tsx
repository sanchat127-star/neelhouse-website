...
const raagVideos: RaagVideo[] = [
  {
    videoId: "gHcTf1YUIrQ",
    title: "Raag Exploration: Understanding Musical Frameworks",
    description: "Discover the intricate melodic patterns and emotional expressions unique to this raag. Experience how traditional Indian classical music theory creates profound emotional connections."
  },
  {
    videoId: "C8XTp7L31jo",
    title: "Raag in Classical Music",
    description: "Learn how raag creates specific moods and atmospheres in compositions. Understanding the raag framework deepens appreciation of the songs and their therapeutic qualities."
  },
  {
    videoId: "54T12bk6Cvw",
    title: "Raag and Emotional Expression",
    description: "Explore the relationship between raag structure and emotional storytelling. See how classical raag principles create timeless compositions."
  },
  {
    videoId: "0W0tLIQfcSU",
    title: "Transformative Power of Raag",
    description: "Witness the transformative power of raag-based composition. This exploration shows how melodic frameworks provide endless creative possibilities while maintaining emotional depth."
  },
  {
    videoId: "wUoAyC2m0DM",
    title: "Raag: Time and Emotion",
  ...
  {
    videoId: "mKHDXR4s-3U",
    title: "Advanced Raag Concepts",
    description: "Delve deeper into the sophisticated aspects of raag in Indian classical music. This performance demonstrates advanced techniques and their application in creating emotionally resonant compositions."
  }
];

export function Raag() {
  return (
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-700 max-w-4xl mx-auto leading-relaxed">
            Journey into the heart of Indian classical music and discover how raag creates emotional depth and spiritual connection
          </p>
        </div>
      </section>
            ...
            <div className="space-y-6 text-gray-800 text-lg leading-relaxed">
              ...
              <div className="bg-white rounded-xl p-6 mt-8 border-l-4 border-amber-500">
                <h3 className="text-2xl mb-4 text-gray-900 flex items-center gap-2">
                  ...
                  How Raag Creates Music
                </h3>
                <p>
                  Masters of Indian classical music have incorporated raag principles into compositions for centuries, creating a unique synthesis 
                  of structure and emotional accessibility. Each composition built upon a raag foundation 
                  guides the listener's emotional journey. Understanding the raag helps listeners connect more deeply with the music's 
                ...
                <p className="mt-4">
                  By learning about different raags, you gain insight into why certain compositions feel uplifting while others 
                  evoke contemplation or melancholy. The raag is the invisible architecture that transforms simple melodies 
                  into profound emotional experiences, making Indian classical music a powerful tool for mental and emotional well-being.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-700 max-w-3xl mx-auto">
              Watch these detailed explorations to understand how each raag creates the foundation for beautiful compositions
            </p>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-700 leading-relaxed">
                Understanding raag unlocks deeper layers of meaning in classical music, revealing the intentional 
            ...
            <div className="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-700 leading-relaxed">
                Each raag is designed to evoke specific emotions. Learning about them helps you select compositions 
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-700 mb-8">
            Explore more ways to experience and learn about musical heritage and its transformative legacy
          </p>
